...
function createArticle(articleData) {
  ...
  figcaption.textContent = articleData.imageCaption;
...
function createArticle(articleData) {
  ...
  const image = document.createElement("img");
  image.src = articleData.image.medium;
  image.alt = articleData.title;
  ...
  image.addEventListener('click', function() {
    dialogImg.src = articleData.image.large;
    dialogImg.alt = articleData.title;
    dialog.showModal();
  });
...
const closeModalSpan = document.querySelector('dialog span');
